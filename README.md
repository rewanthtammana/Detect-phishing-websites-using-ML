...
This project is a simple example that trains the model to predict phishing websites. Phishing websites are fake websites that try to gain the trust of users to steal private data of users.
